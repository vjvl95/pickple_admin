...
export const PROFILE_OPEN_FAILURE="PROFILE_OPEN_FAILURE";
export const PROFILE_OPEN_SUCCESS="PROFILE_OPEN_SUCCESS";

export const PROFILE_CLOSE_REQUEST="PROFILE_CLOSE_REQUEST";
export const PROFILE_CLOSE_FAILURE="PROFILE_CLOSE_FAILURE";
export const PROFILE_CLOSE_SUCCESS="PROFILE_CLOSE_SUCCESS";